...
public class MiJuego extends ApplicationAdapter implements InputProcessor {
	...
	//Celdas inicial recorrido del personaje principal
	private Vector2 celdaInicial;
	...
	public void create () {
		...
		tesoroEncontrado = Gdx.audio.newSound(Gdx.files.internal("music/tesoro_by_funwithsound.mp3"));
		...
		musicaJuego = Gdx.audio.newMusic(Gdx.files.internal("music/song.mp3"));
		...
		TiledMapTileLayer capaSuelo2 = (TiledMapTileLayer) mapa.getLayers().get(0);
		TiledMapTileLayer capaSuelo = (TiledMapTileLayer) mapa.getLayers().get(1);
		...
		capaTesoros = (TiledMapTileLayer) mapa.getLayers().get(4);
		...
		celdaInicial = new Vector2(1, 0);
		celdaFinal = new Vector2(23, 10);
		...
		imagenPrincipal = new Texture(Gdx.files.internal("gallery_11419_57_4479.png"));
		...
		celdaInicial = new Vector2(1, 0);
		celdaFinal = new Vector2(23, 10); //el tile final en el mapa de ejemplo
...
//Imágenes de cada npc
		imgNPC[0] = new Texture(Gdx.files.internal("gallery_11419_57_5920.png"));
		imgNPC[1] = new Texture(Gdx.files.internal("gallery_11419_57_5920.png"));
		imgNPC[2] = new Texture(Gdx.files.internal("gallery_11419_57_5920.png"));
		imgNPC[3] = new Texture(Gdx.files.internal("gallery_11419_57_5920.png"));
		imgNPC[4] = new Texture(Gdx.files.internal("gallery_11419_57_5920.png"));
...
//la funcion posicionaMapa para traducirlo a puntos del mapa.
		origen[0] = posicionaMapa(new Vector2(7, 2));
		destino[0] = posicionaMapa(new Vector2(11, 2));
		origen[1] = posicionaMapa(new Vector2(5, 3));
		destino[1] = posicionaMapa(new Vector2(5, 5));
		origen[2] = posicionaMapa(new Vector2(6, 9));
		destino[2] = posicionaMapa(new Vector2(9, 9));
		origen[3] = posicionaMapa(new Vector2(15, 5));
		destino[3] = posicionaMapa(new Vector2(15, 8));
		origen[4] = posicionaMapa(new Vector2(20, 12));
		destino[4] = posicionaMapa(new Vector2(24, 12));
